 ...
 */
export async function migrateLegacyShellMarkers() {
 ...
 */
export async function migrateLegacyLayout(claudeConfigDir, claudeSyncDir) {
    const result = { movedDir: false, updatedShellFiles: [] };
